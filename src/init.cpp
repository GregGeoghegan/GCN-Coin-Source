    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("GCoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  GCoind [options]                     " + "\n" +
                  "  GCoind [options] <command> [params]  " + _("Send command to -server or GCoind") + "\n" +
                  "  GCoind [options] help                " + _("List commands") + "\n" +
                  "  GCoind [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: GCoind.pid)") + "\n" +
        ...
        "\n" + _("SSL options: (see the GCoin Wiki for SSL setup instructions)") + "\n" +
...
//    }
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. GCoin is probably already running."), strDataDir.c_str()));
