...
static const int64 MAX_MONEY = 200000000000 * COIN; // GCoin: maximum of N coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 2 * COIN * (60 * 24 / 2) / 250; // GCoin: Priority cutoff is 2 GCoin day / 250 bytes.
    }
